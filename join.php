        ...
        <section class="banner full">
          ...
          <!-- 1 -->
                ...
                <header class="align-center">
      						<h2>Audience registration</h2>
      					</header>
                <div>
                  <form method='post'  action='join_action.php'>
                    <div style="text-align: center;">
                      <div class="box">
                        <p>"오늘의 명화"는 어떠한 개인정보도 요구하지 않습니다. 따라서 입력하신 아이디와 비밀번호를 반드시 기억해주세요. </p>
                      </div>
                      <div>
                        <div class="12u$" >
                          ID:<input type="text" name="id" id="name" value="" placeholder="사용할 id" />
                        </div>
                      </div>
                      <br>
                      <br>
                      <div>
                        <div class="12u$">
                          PW:<input type="password" name="pw" value="" placeholder="password" />
                        </div>
                      </div>
                      <div>
                        <div class="12u$">
                          PW확인:<input type="password" name="pwcf" value="" placeholder="password 확인" />
                        </div>
                      </div>
                      <br>
                      <!-- Break -->
                      <div class="12u$">
                        <ul class="actions">
                          <li><input type="submit" value="관람객 등록하기" /></li>
                        </ul>
                      </div>
                    </div>
                  </form>
