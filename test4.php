...
$sql = "SELECT * FROM all_impression WHERE all_impression.picture_name='$picname' order by like_count desc";
...
while($row = mysqli_fetch_array($result)){
  ...
  <tr>
    <th scope="row">
    <span id="rownum'.$seq.'" class="rowseq"></span>
    <input type=radio id=radio'.$seq.' value="'.$seq.'" name=seq>
    </th>
    <td>'.$row['audience'].'</td>
    <td>
